                ...
                methods.forEach((method, _j) => {
                    ...
                    describe(method.desc, () => {
                        beforeEach(async () => {
                            ...
                            await db.friends.update(updateId, { friendsId: [hasFriendId] });
                            friend.friendsId = [hasFriendId];
                        ...
                        fit('should emit the correct value', async () => {
                        ...
                        if (['Table.$'].includes(method.desc)) {
                            it('should emit on adding/removing to the table', async () => {
                                ...
                                await waits[0].promise;
                                expect(emitCount).toBe(1);
                                expect(collection!).toEqual([friend, hasFriend]);
